...
class Test{
    public static void main(String[] args) {
        ...
        System.out.println("studentInfo.testStudent(students, new CheckOverGrade()):");
        studentInfo.testStudent(students, new CheckOverGrade());

        System.out.println();
        System.out.println("studentInfo.testStudent(students, new StudentCheck(){...}:");
        ...
        System.out.println();
        System.out.println("studentInfo.testStudent(students, (Student student) -> {return student.age >25;}):");
        studentInfo.testStudent(students, (Student student) -> {return student.age >25;});

        System.out.println();
        System.out.println("studentInfo.testStudent(students, student -> student.age >25):");
        studentInfo.testStudent(students, student -> student.age >25);
    }
}
